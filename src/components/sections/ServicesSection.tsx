...
import { Service, services } from '@/src/data/services'
...
function ServiceCard({ service }: { service: Service }) {
  ...
  return (
    <div className="group rounded-2xl border border-slate-800 bg-slate-900 p-6 shadow-[0_18px_40px_rgba(15,23,42,0.7)] hover:-translate-y-1 hover:border-cyan-500/60 hover:shadow-[0_20px_45px_rgba(8,47,73,0.9)] transition-all duration-300">
